...
export default async function About() {
    ...
    return (
        <div className="relative flex min-h-screen w-full flex-col bg-background-light dark:bg-background-dark overflow-x-hidden pb-24 lg:pb-0 transition-colors duration-300">
            {/* Header */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
                    ...
                    <div className="md:col-span-5 relative pl-8 py-4">
                        ...
                        <div className="mt-12 rounded-xl overflow-hidden aspect-square border border-slate-200 dark:border-slate-800 shadow-lg">
                            <img alt="Abstract visualization" className="w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-700" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBSbfaTfM8m8hOiq6HwW6_VM0Ub2Z2MaKa7hwyfCSBJk0jPtSXWFf7yOaYz_OBJkjxs2A5uxr3YJDL5wWHZnRNFFG6JT0-TrPBkOuFIle74DZoqRseKOQV7Iub0hBjjaH-ygKdxLe1-z11_5fajXIkOp4xg5j6d9YGTY2hyEF1_Tvyvy14SC5fuze3FbIqrr3D76o1mqCKbkGPI_WRYskB4A4sK3NFomm1h-A7OBd48EVKqyZLHJ04nZS5Y8d6cDgt14ouZaA9wi-E" />
                        </div>
                    </div>
                </div>
            </main>
